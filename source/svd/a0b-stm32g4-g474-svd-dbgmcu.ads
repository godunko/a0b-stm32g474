...
package A0B.STM32G4.G474.SVD.DBGMCU is
   pragma Preelaborate;
   ...
   subtype IDCODE_DEV_ID_Field is A0B.Types.SVD.UInt16;
   subtype IDCODE_REV_ID_Field is A0B.Types.SVD.UInt16;
   ...
   subtype CR_TRACE_MODE_Field is A0B.Types.SVD.UInt2;
   ...
   type APB1L_FZ_Register is record
      ...
      --  unspecified
      Reserved_6_9     : A0B.Types.SVD.UInt4 := 16#0#;
      ...
      --  unspecified
      Reserved_23_29   : A0B.Types.SVD.UInt7 := 16#0#;
   ...
   type APB2_FZ_Register is record
      ...
      --  unspecified
      Reserved_21_25  : A0B.Types.SVD.UInt5 := 16#0#;
      --  DBG_HRTIM0_STOP
   ...
   type DBGMCU_Peripheral is record
      ...
      pragma Volatile_Full_Access (APB1L_FZ);
      --  APB Low Freeze Register 2
      APB1H_FZ : aliased APB1H_FZ_Register;
      pragma Volatile_Full_Access (APB1H_FZ);
      --  APB High Freeze Register
...
end A0B.STM32G4.G474.SVD.DBGMCU;
