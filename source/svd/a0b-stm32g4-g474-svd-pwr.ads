...
package A0B.STM32G4.G474.SVD.PWR is
   pragma Preelaborate;
   ...
   type PWR_CR1_Register is record
      ...
      LPMS           : PWR_CR1_LPMS_Field := A0B.STM32G4.G474.SVD.PWR.B_0x0;
      --  FPD_STOP
      ...
      DBP            : PWR_CR1_DBP_Field := A0B.STM32G4.G474.SVD.PWR.B_0x0;
      --  Voltage scaling range selection
      VOS            : PWR_CR1_VOS_Field := A0B.STM32G4.G474.SVD.PWR.B_0x1;
      --  unspecified
...
--  V<sub>REFINT</sub>)
   ...
   type PWR_CR2_Register is record
      ...
      PVDE          : PWR_CR2_PVDE_Field := A0B.STM32G4.G474.SVD.PWR.B_0x0;
      ...
      PVDLS         : PWR_CR2_PVDLS_Field := A0B.STM32G4.G474.SVD.PWR.B_0x0;
      --  unspecified
      Reserved_4_5  : A0B.Types.SVD.UInt2 := 16#0#;
      --  Peripheral voltage monitoring 3 enable: V<sub>DDA</sub> vs. ADC/COMP
      --  min voltage 1.62V
      PVMEN1        : PWR_CR2_PVMEN1_Field := A0B.STM32G4.G474.SVD.PWR.B_0x0;
      --  Peripheral voltage monitoring 4 enable: V<sub>DDA</sub> vs. DAC 1MSPS
      --  /DAC 15MSPS min voltage.
      PVMEN2        : PWR_CR2_PVMEN2_Field := A0B.STM32G4.G474.SVD.PWR.B_0x0;
      --  unspecified
...
--  UCPD1_CC2 pins.
   ...
   type PWR_CR3_Register is record
      ...
      --  SRAM2 retention in Standby mode
      RRS            : PWR_CR3_RRS_Field := A0B.STM32G4.G474.SVD.PWR.B_0x0;
      --  unspecified
      ...
      UCPD1_STDBY    : PWR_CR3_UCPD1_STDBY_Field :=
                        A0B.STM32G4.G474.SVD.PWR.B_0x0;
      ...
      UCPD1_DBDIS    : PWR_CR3_UCPD1_DBDIS_Field :=
                        A0B.STM32G4.G474.SVD.PWR.B_0x0;
      --  Enable internal wakeup line
      EIWUL          : PWR_CR3_EIWUL_Field := A0B.STM32G4.G474.SVD.PWR.B_0x1;
      --  unspecified
   ...
   type PWR_CR4_Register is record
      ...
      Reserved_5_7   : A0B.Types.SVD.UInt3 := 16#0#;
      --  V<sub>BAT</sub> battery charging enable
      VBE            : PWR_CR4_VBE_Field := A0B.STM32G4.G474.SVD.PWR.B_0x0;
      --  V<sub>BAT</sub> battery charging resistor selection
      VBRS           : PWR_CR4_VBRS_Field := A0B.STM32G4.G474.SVD.PWR.B_0x0;
      --  unspecified
   ...
   type PWR_CR5_Register is record
      ...
      --  Refer to
      R1MODE        : PWR_CR5_R1MODE_Field := A0B.STM32G4.G474.SVD.PWR.B_0x1;
      --  unspecified
      Reserved_9_31 : A0B.Types.SVD.UInt23 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
