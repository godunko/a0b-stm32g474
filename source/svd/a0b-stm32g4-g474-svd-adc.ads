...
package A0B.STM32G4.G474.SVD.ADC is
   pragma Preelaborate;
   ...
   subtype CFGR_RES_Field is A0B.Types.SVD.UInt2;
   subtype CFGR_EXTSEL_Field is A0B.Types.SVD.UInt5;
   subtype CFGR_EXTEN_Field is A0B.Types.SVD.UInt2;
   subtype CFGR_DISCNUM_Field is A0B.Types.SVD.UInt3;
   subtype CFGR_AWD1CH_Field is A0B.Types.SVD.UInt5;
   ...
   subtype CFGR2_OVSR_Field is A0B.Types.SVD.UInt3;
   subtype CFGR2_OVSS_Field is A0B.Types.SVD.UInt4;
   ...
   type CFGR2_Register is record
      ...
      GCOMP          : Boolean := False;
      --  unspecified
      Reserved_17_24 : A0B.Types.SVD.Byte := 16#0#;
      --  SWTRIG
   ...
   subtype SMPR1_SMP_Element is A0B.Types.SVD.UInt3;
   ...
   subtype SMPR2_SMP_Element is A0B.Types.SVD.UInt3;
   ...
   subtype TR1_LT1_Field is A0B.Types.SVD.UInt12;
   subtype TR1_AWDFILT_Field is A0B.Types.SVD.UInt3;
   subtype TR1_HT1_Field is A0B.Types.SVD.UInt12;
   ...
   subtype TR2_LT2_Field is A0B.Types.SVD.Byte;
   subtype TR2_HT2_Field is A0B.Types.SVD.Byte;
   ...
   subtype TR3_LT3_Field is A0B.Types.SVD.Byte;
   subtype TR3_HT3_Field is A0B.Types.SVD.Byte;
   ...
   subtype SQR1_L_Field is A0B.Types.SVD.UInt4;
   subtype SQR1_SQ1_Field is A0B.Types.SVD.UInt5;
   subtype SQR1_SQ2_Field is A0B.Types.SVD.UInt5;
   subtype SQR1_SQ3_Field is A0B.Types.SVD.UInt5;
   subtype SQR1_SQ4_Field is A0B.Types.SVD.UInt5;
   ...
   subtype SQR2_SQ5_Field is A0B.Types.SVD.UInt5;
   subtype SQR2_SQ6_Field is A0B.Types.SVD.UInt5;
   subtype SQR2_SQ7_Field is A0B.Types.SVD.UInt5;
   subtype SQR2_SQ8_Field is A0B.Types.SVD.UInt5;
   subtype SQR2_SQ9_Field is A0B.Types.SVD.UInt5;
   ...
   subtype SQR3_SQ10_Field is A0B.Types.SVD.UInt5;
   subtype SQR3_SQ11_Field is A0B.Types.SVD.UInt5;
   subtype SQR3_SQ12_Field is A0B.Types.SVD.UInt5;
   subtype SQR3_SQ13_Field is A0B.Types.SVD.UInt5;
   subtype SQR3_SQ14_Field is A0B.Types.SVD.UInt5;
   ...
   subtype SQR4_SQ15_Field is A0B.Types.SVD.UInt5;
   subtype SQR4_SQ16_Field is A0B.Types.SVD.UInt5;
   ...
   subtype DR_RDATA_Field is A0B.Types.SVD.UInt16;
   ...
   subtype JSQR_JL_Field is A0B.Types.SVD.UInt2;
   subtype JSQR_JEXTSEL_Field is A0B.Types.SVD.UInt5;
   subtype JSQR_JEXTEN_Field is A0B.Types.SVD.UInt2;
   subtype JSQR_JSQ1_Field is A0B.Types.SVD.UInt5;
   subtype JSQR_JSQ2_Field is A0B.Types.SVD.UInt5;
   subtype JSQR_JSQ3_Field is A0B.Types.SVD.UInt5;
   subtype JSQR_JSQ4_Field is A0B.Types.SVD.UInt5;
   ...
   subtype OFR_OFFSET1_Field is A0B.Types.SVD.UInt12;
   subtype OFR_OFFSET1_CH_Field is A0B.Types.SVD.UInt5;
   ...
   subtype JDR1_JDATA1_Field is A0B.Types.SVD.UInt16;
   ...
   subtype JDR2_JDATA2_Field is A0B.Types.SVD.UInt16;
   ...
   subtype JDR3_JDATA3_Field is A0B.Types.SVD.UInt16;
   ...
   subtype JDR4_JDATA4_Field is A0B.Types.SVD.UInt16;
   ...
   subtype AWD2CR_AWD2CH_Field is A0B.Types.SVD.UInt19;
   ...
   subtype AWD3CR_AWD3CH_Field is A0B.Types.SVD.UInt19;
   ...
   subtype DIFSEL_DIFSEL_1_18_Field is A0B.Types.SVD.UInt18;
   ...
   subtype CALFACT_CALFACT_S_Field is A0B.Types.SVD.UInt7;
   subtype CALFACT_CALFACT_D_Field is A0B.Types.SVD.UInt7;
   ...
   subtype GCOMP_GCOMPCOEFF_Field is A0B.Types.SVD.UInt14;
   ...
   subtype CCR_MDMA_Field is A0B.Types.SVD.UInt2;
   ...
   subtype CFGR_AWDCH1CH_Field is A0B.Types.SVD.UInt5;
   ...
   type ADC1_Peripheral is record
      ...
      pragma Volatile_Full_Access (TR1);
      --  watchdog threshold register
      TR2     : aliased TR2_Register;
      pragma Volatile_Full_Access (TR2);
      --  watchdog threshold register 3
      TR3     : aliased TR3_Register;
      pragma Volatile_Full_Access (TR3);
      --  regular sequence register 1
      ...
      pragma Volatile_Full_Access (SQR4);
      --  regular Data Register
      ...
      pragma Volatile_Full_Access (OFR1);
      --  offset register 2
      OFR2    : aliased OFR_Register;
      pragma Volatile_Full_Access (OFR2);
      --  offset register 3
      OFR3    : aliased OFR_Register;
      pragma Volatile_Full_Access (OFR3);
      --  offset register 4
      OFR4    : aliased OFR_Register;
      pragma Volatile_Full_Access (OFR4);
      --  injected data register 1
      ...
      pragma Volatile_Full_Access (AWD2CR);
      --  Analog Watchdog 3 Configuration Register
      AWD3CR  : aliased AWD3CR_Register;
      pragma Volatile_Full_Access (AWD3CR);
      --  Differential Mode Selection Register 2
      DIFSEL  : aliased DIFSEL_Register;
      pragma Volatile_Full_Access (DIFSEL);
      --  Calibration Factors
      CALFACT : aliased CALFACT_Register;
      pragma Volatile_Full_Access (CALFACT);
      --  Gain compensation Register
      GCOMP   : aliased GCOMP_Register;
      pragma Volatile_Full_Access (GCOMP);
   end record
     with Volatile;
