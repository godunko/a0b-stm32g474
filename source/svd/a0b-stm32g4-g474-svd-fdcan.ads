...
package A0B.STM32G4.G474.SVD.FDCAN is
   pragma Preelaborate;
   ...
   type FDCAN_DBTP_Register is record
      ...
      TDC            : FDCAN_DBTP_TDC_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  unspecified
...
--  of the CAN bit time
   ...
   type FDCAN_TEST_Register is record
      ...
      LBCK          : FDCAN_TEST_LBCK_Field :=
                       A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Control of transmit pin
      TX            : FDCAN_TEST_TX_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Read-only. Receive pin Monitors the actual value of pin FDCANx_RX
      RX            : FDCAN_TEST_RX_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  unspecified
...
--  synchronization
   ...
   type FDCAN_CCCR_Register is record
      --  Initialization
      INIT           : FDCAN_CCCR_INIT_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x1;
      --  Configuration change enable
      CCE            : FDCAN_CCCR_CCE_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      ...
      ASM            : FDCAN_CCCR_ASM_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Read-only. Clock stop acknowledge
      CSA            : FDCAN_CCCR_CSA_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Clock stop request
      CSR            : FDCAN_CCCR_CSR_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Bus monitoring mode Bit MON can only be set by software when both CCE
      --  and INIT are set to 1. The bit can be reset by the Host at any time.
      MON            : FDCAN_CCCR_MON_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Disable automatic retransmission
      DAR            : FDCAN_CCCR_DAR_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Test mode enable
      TEST           : FDCAN_CCCR_TEST_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  FD operation enable
      FDOE           : FDCAN_CCCR_FDOE_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  FDCAN bit rate switching
      BRSE           : FDCAN_CCCR_BRSE_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  unspecified
      Reserved_10_11 : A0B.Types.SVD.UInt2 := 16#0#;
      --  Protocol exception handling disable
      PXHD           : FDCAN_CCCR_PXHD_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Edge filtering during bus integration
      EFBI           : FDCAN_CCCR_EFBI_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  If this bit is set, the FDCAN pauses for two CAN bit times before
      --  starting the next transmission after successfully transmitting a
      --  frame.
      TXP            : FDCAN_CCCR_TXP_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Non ISO operation If this bit is set, the FDCAN uses the CAN FD frame
      --  format as specified by the Bosch CAN FD Specification V1.0.
      NISO           : FDCAN_CCCR_NISO_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  unspecified
      Reserved_16_31 : A0B.Types.SVD.UInt16 := 16#0#;
   end record
   ...
   type FDCAN_ECR_Register is record
      ...
      RP             : FDCAN_ECR_RP_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
...
--  detected.
   ...
   type FDCAN_PSR_Register is record
      ...
      --  transferred (reception or transmission) without error. Access type is
      --  RS: set on read.
      LEC            : FDCAN_PSR_LEC_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x7;
      --  Read-only. Activity Monitors the modules CAN communication state.
      ACT            : FDCAN_PSR_ACT_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Read-only. Error passive
      EP             : FDCAN_PSR_EP_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Read-only. Warning Sstatus
      EW             : FDCAN_PSR_EW_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Read-only. Bus_Off status
      BO             : FDCAN_PSR_BO_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      ...
      --  on read.
      RESI           : FDCAN_PSR_RESI_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  BRS flag of last received FDCAN message This bit is set together with
      --  REDL, independent of acceptance filtering. Access type is RX: reset
      --  on read.
      RBRS           : FDCAN_PSR_RBRS_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Received FDCAN message This bit is set independent of acceptance
      --  filtering. Access type is RX: reset on read.
      REDL           : FDCAN_PSR_REDL_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Protocol exception event
      PXE            : FDCAN_PSR_PXE_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  unspecified
   ...
   type FDCAN_IR_Register is record
      ...
      RF1L           : FDCAN_IR_RF1L_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  High-priority message
      HPM            : FDCAN_IR_HPM_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Transmission completed
      TC             : FDCAN_IR_TC_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Transmission cancellation finished
      TCF            : FDCAN_IR_TCF_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Tx FIFO empty
      TFE            : FDCAN_IR_TFE_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Tx event FIFO New Entry
      ...
      TEFL           : FDCAN_IR_TEFL_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Timestamp wraparound
      TSW            : FDCAN_IR_TSW_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      ...
      MRAF           : FDCAN_IR_MRAF_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Timeout occurred
      TOO            : FDCAN_IR_TOO_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Error logging overflow
      ELO            : FDCAN_IR_ELO_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Error passive
      EP             : FDCAN_IR_EP_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Warning status
      EW             : FDCAN_IR_EW_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Bus_Off status
      BO             : FDCAN_IR_BO_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Watchdog interrupt
      WDI            : FDCAN_IR_WDI_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Protocol error in arbitration phase (nominal bit time is used)
      PEA            : FDCAN_IR_PEA_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Protocol error in data phase (data bit time is used)
      PED            : FDCAN_IR_PED_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Access to reserved address
      ARA            : FDCAN_IR_ARA_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  unspecified
      Reserved_24_31 : A0B.Types.SVD.Byte := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   type FDCAN_IE_Register is record
      ...
      HPME           : FDCAN_IE_HPME_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Transmission completed interrupt enable
      TCE            : FDCAN_IE_TCE_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Transmission cancellation finished interrupt enable
      TCFE           : FDCAN_IE_TCFE_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Tx FIFO empty interrupt enable
      TFEE           : FDCAN_IE_TFEE_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Tx event FIFO new entry interrupt enable
      ...
      ELOE           : FDCAN_IE_ELOE_Field :=
                        A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Error passive interrupt enable
      EPE            : FDCAN_IE_EPE_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Warning status interrupt enable
      EWE            : FDCAN_IE_EWE_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Bus_Off status
      BOE            : FDCAN_IE_BOE_Field := A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Watchdog interrupt enable
   ...
   type FDCAN_ILE_Register is record
      --  Enable interrupt line 0
      EINT0         : FDCAN_ILE_EINT0_Field :=
                       A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  Enable interrupt line 1
      EINT1         : FDCAN_ILE_EINT1_Field :=
                       A0B.STM32G4.G474.SVD.FDCAN.B_0x0;
      --  unspecified
...
end A0B.STM32G4.G474.SVD.FDCAN;
