...
package A0B.STM32G4.G474.SVD.UCPD is
   pragma Preelaborate;
   ...
   subtype CFG1_HBITCLKDIV_Field is A0B.Types.SVD.UInt6;
   subtype CFG1_IFRGAP_Field is A0B.Types.SVD.UInt5;
   subtype CFG1_TRANSWIN_Field is A0B.Types.SVD.UInt5;
   subtype CFG1_PSC_USBPDCLK_Field is A0B.Types.SVD.UInt3;
   subtype CFG1_RXORDSETEN_Field is A0B.Types.SVD.UInt9;
   ...
   subtype CR_TXMODE_Field is A0B.Types.SVD.UInt2;
   subtype CR_ANASUBMODE_Field is A0B.Types.SVD.UInt2;
   subtype CR_CCENABLE_Field is A0B.Types.SVD.UInt2;
   ...
   subtype SR_TYPEC_VSTATE_CC_Element is A0B.Types.SVD.UInt2;
   ...
   subtype TX_ORDSET_TXORDSET_Field is A0B.Types.SVD.UInt20;
   ...
   subtype TX_PAYSZ_TXPAYSZ_Field is A0B.Types.SVD.UInt10;
   ...
   subtype TXDR_TXDATA_Field is A0B.Types.SVD.Byte;
   ...
   subtype RX_ORDSET_RXORDSET_Field is A0B.Types.SVD.UInt3;
   subtype RX_ORDSET_RXSOPKINVALID_Field is A0B.Types.SVD.UInt3;
   ...
   subtype RX_PAYSZ_RXPAYSZ_Field is A0B.Types.SVD.UInt10;
   ...
   type RX_PAYSZ_Register is record
      ...
      --  unspecified
      Reserved_10_31 : A0B.Types.SVD.UInt22;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype RXDR_RXDATA_Field is A0B.Types.SVD.Byte;
   ...
   subtype RX_ORDEXT1_RXSOPX1_Field is A0B.Types.SVD.UInt20;
   ...
   subtype RX_ORDEXT2_RXSOPX2_Field is A0B.Types.SVD.UInt20;
