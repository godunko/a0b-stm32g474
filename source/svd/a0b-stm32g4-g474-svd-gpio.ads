...
package A0B.STM32G4.G474.SVD.GPIO is
   pragma Preelaborate;
   ...
   --  MODER array element
   subtype MODER_Element is A0B.Types.SVD.UInt2;
   ...
   subtype OSPEEDR_Element is A0B.Types.SVD.UInt2;
   ...
   --  PUPDR array element
   subtype PUPDR_Element is A0B.Types.SVD.UInt2;
   ...
   --  AFRL array element
   subtype AFRL_Element is A0B.Types.SVD.UInt4;
   ...
   --  AFRH array element
   subtype AFRH_Element is A0B.Types.SVD.UInt4;
