...
package A0B.STM32G4.G474.SVD.TIM is
   pragma Preelaborate;
   ...
   type DIER_Register is record
      ...
      TDE            : Boolean := False;
      --  unspecified
      Reserved_15_19 : A0B.Types.SVD.UInt5 := 16#0#;
   ...
   subtype CCMR1_Input_IC2PSC_Field is A0B.Types.SVD.UInt2;
   ...
   subtype RCR_REP_Field is A0B.Types.SVD.UInt16;
   ...
   subtype CCR6_CCR6_Field is A0B.Types.SVD.UInt16;
   ...
   subtype CCMR3_Output_OC5M_bit3_Field is A0B.Types.SVD.UInt3;
   ...
   subtype DTR2_DTGF_Field is A0B.Types.SVD.Byte;
   ...
   subtype ECR_IDIR_Field is A0B.Types.SVD.UInt2;
   subtype ECR_IBLK_Field is A0B.Types.SVD.UInt2;
   subtype ECR_IPOS_Field is A0B.Types.SVD.UInt2;
   subtype ECR_PW_Field is A0B.Types.SVD.Byte;
   subtype ECR_PWPRSC_Field is A0B.Types.SVD.UInt3;
   ...
   subtype AF2_OCRSEL_Field is A0B.Types.SVD.UInt3;
   ...
   subtype CCMR1_Input_IC1PSC_Field is A0B.Types.SVD.UInt2;
   ...
   subtype RCR_REP_Field_1 is A0B.Types.SVD.Byte;
   ...
   type BDTR_Register_1 is record
      ...
      BKF            : BDTR_BKF_Field := 16#0#;
      --  unspecified
      Reserved_20_25 : A0B.Types.SVD.UInt6 := 16#0#;
      --  BKDSRM
      BKDSRM         : Boolean := False;
      --  unspecified
   ...
   is record
      ...
      pragma Volatile_Full_Access (DTR2);
      --  DMA control register
      ...
      DMAR         : aliased A0B.Types.SVD.UInt32;
   ...
   is record
      ...
      pragma Volatile_Full_Access (OR1);
      --  DMA control register
      DCR          : aliased DCR_Register;
      pragma Volatile_Full_Access (DCR);
      --  DMA address for full transfer
