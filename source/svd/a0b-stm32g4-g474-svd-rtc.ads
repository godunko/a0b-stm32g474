...
package A0B.STM32G4.G474.SVD.RTC is
   pragma Preelaborate;
   ...
   subtype TR_SU_Field is A0B.Types.SVD.UInt4;
   subtype TR_ST_Field is A0B.Types.SVD.UInt3;
   subtype TR_MNU_Field is A0B.Types.SVD.UInt4;
   subtype TR_MNT_Field is A0B.Types.SVD.UInt3;
   subtype TR_HU_Field is A0B.Types.SVD.UInt4;
   subtype TR_HT_Field is A0B.Types.SVD.UInt2;
   ...
   subtype DR_DU_Field is A0B.Types.SVD.UInt4;
   subtype DR_DT_Field is A0B.Types.SVD.UInt2;
   subtype DR_MU_Field is A0B.Types.SVD.UInt4;
   subtype DR_WDU_Field is A0B.Types.SVD.UInt3;
   subtype DR_YU_Field is A0B.Types.SVD.UInt4;
   subtype DR_YT_Field is A0B.Types.SVD.UInt4;
   ...
   subtype SSR_SS_Field is A0B.Types.SVD.UInt16;
   ...
   subtype PRER_PREDIV_S_Field is A0B.Types.SVD.UInt15;
   subtype PRER_PREDIV_A_Field is A0B.Types.SVD.UInt7;
   ...
   subtype WUTR_WUT_Field is A0B.Types.SVD.UInt16;
   ...
   subtype CR_WCKSEL_Field is A0B.Types.SVD.UInt3;
   subtype CR_OSEL_Field is A0B.Types.SVD.UInt2;
   ...
   subtype WPR_KEY_Field is A0B.Types.SVD.Byte;
   ...
   subtype CALR_CALM_Field is A0B.Types.SVD.UInt9;
   ...
   type CALR_Register is record
      ...
      --  unspecified
      Reserved_9_12  : A0B.Types.SVD.UInt4 := 16#0#;
   ...
   subtype SHIFTR_SUBFS_Field is A0B.Types.SVD.UInt15;
   ...
   type SHIFTR_Register is record
      ...
      --  unspecified
      Reserved_15_30 : A0B.Types.SVD.UInt16 := 16#0#;
   ...
   subtype TSTR_SU_Field is A0B.Types.SVD.UInt4;
   subtype TSTR_ST_Field is A0B.Types.SVD.UInt3;
   subtype TSTR_MNU_Field is A0B.Types.SVD.UInt4;
   subtype TSTR_MNT_Field is A0B.Types.SVD.UInt3;
   subtype TSTR_HU_Field is A0B.Types.SVD.UInt4;
   subtype TSTR_HT_Field is A0B.Types.SVD.UInt2;
   ...
   subtype TSDR_DU_Field is A0B.Types.SVD.UInt4;
   subtype TSDR_DT_Field is A0B.Types.SVD.UInt2;
   subtype TSDR_MU_Field is A0B.Types.SVD.UInt4;
   subtype TSDR_WDU_Field is A0B.Types.SVD.UInt3;
   ...
   subtype TSSSR_SS_Field is A0B.Types.SVD.UInt16;
   ...
   subtype ALRMAR_SU_Field is A0B.Types.SVD.UInt4;
   subtype ALRMAR_ST_Field is A0B.Types.SVD.UInt3;
   subtype ALRMAR_MNU_Field is A0B.Types.SVD.UInt4;
   subtype ALRMAR_MNT_Field is A0B.Types.SVD.UInt3;
   subtype ALRMAR_HU_Field is A0B.Types.SVD.UInt4;
   subtype ALRMAR_HT_Field is A0B.Types.SVD.UInt2;
   subtype ALRMAR_DU_Field is A0B.Types.SVD.UInt4;
   subtype ALRMAR_DT_Field is A0B.Types.SVD.UInt2;
   ...
   subtype ALRMASSR_SS_Field is A0B.Types.SVD.UInt15;
   subtype ALRMASSR_MASKSS_Field is A0B.Types.SVD.UInt4;
   ...
   type ALRMASSR_Register is record
      ...
      --  unspecified
      Reserved_15_23 : A0B.Types.SVD.UInt9 := 16#0#;
   ...
   subtype ALRMBR_SU_Field is A0B.Types.SVD.UInt4;
   subtype ALRMBR_ST_Field is A0B.Types.SVD.UInt3;
   subtype ALRMBR_MNU_Field is A0B.Types.SVD.UInt4;
   subtype ALRMBR_MNT_Field is A0B.Types.SVD.UInt3;
   subtype ALRMBR_HU_Field is A0B.Types.SVD.UInt4;
   subtype ALRMBR_HT_Field is A0B.Types.SVD.UInt2;
   subtype ALRMBR_DU_Field is A0B.Types.SVD.UInt4;
   subtype ALRMBR_DT_Field is A0B.Types.SVD.UInt2;
   ...
   subtype ALRMBSSR_SS_Field is A0B.Types.SVD.UInt15;
   subtype ALRMBSSR_MASKSS_Field is A0B.Types.SVD.UInt4;
   ...
   type RTC_Peripheral is record
      ...
      pragma Volatile_Full_Access (ICSR);
      --  prescaler register
