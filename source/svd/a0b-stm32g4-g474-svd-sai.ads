...
package A0B.STM32G4.G474.SVD.SAI is
   pragma Preelaborate;
   ...
   subtype ACR1_MODE_Field is A0B.Types.SVD.UInt2;
   subtype ACR1_PRTCFG_Field is A0B.Types.SVD.UInt2;
   subtype ACR1_DS_Field is A0B.Types.SVD.UInt3;
   subtype ACR1_SYNCEN_Field is A0B.Types.SVD.UInt2;
   subtype ACR1_MCJDIV_Field is A0B.Types.SVD.UInt6;
   ...
   subtype ACR2_FTH_Field is A0B.Types.SVD.UInt3;
   subtype ACR2_MUTECN_Field is A0B.Types.SVD.UInt6;
   subtype ACR2_COMP_Field is A0B.Types.SVD.UInt2;
   ...
   subtype AFRCR_FRL_Field is A0B.Types.SVD.Byte;
   subtype AFRCR_FSALL_Field is A0B.Types.SVD.UInt7;
   ...
   subtype ASLOTR_FBOFF_Field is A0B.Types.SVD.UInt5;
   subtype ASLOTR_SLOTSZ_Field is A0B.Types.SVD.UInt2;
   subtype ASLOTR_NBSLOT_Field is A0B.Types.SVD.UInt4;
   subtype ASLOTR_SLOTEN_Field is A0B.Types.SVD.UInt16;
   ...
   subtype ASR_FLVL_Field is A0B.Types.SVD.UInt3;
   ...
   subtype BCR1_MODE_Field is A0B.Types.SVD.UInt2;
   subtype BCR1_PRTCFG_Field is A0B.Types.SVD.UInt2;
   subtype BCR1_DS_Field is A0B.Types.SVD.UInt3;
   subtype BCR1_SYNCEN_Field is A0B.Types.SVD.UInt2;
   subtype BCR1_MCJDIV_Field is A0B.Types.SVD.UInt6;
   ...
   subtype BCR2_FTH_Field is A0B.Types.SVD.UInt3;
   subtype BCR2_MUTECN_Field is A0B.Types.SVD.UInt6;
   subtype BCR2_COMP_Field is A0B.Types.SVD.UInt2;
   ...
   subtype BFRCR_FRL_Field is A0B.Types.SVD.Byte;
   subtype BFRCR_FSALL_Field is A0B.Types.SVD.UInt7;
   ...
   subtype BSLOTR_FBOFF_Field is A0B.Types.SVD.UInt5;
   subtype BSLOTR_SLOTSZ_Field is A0B.Types.SVD.UInt2;
   subtype BSLOTR_NBSLOT_Field is A0B.Types.SVD.UInt4;
   subtype BSLOTR_SLOTEN_Field is A0B.Types.SVD.UInt16;
   ...
   subtype BSR_FLVL_Field is A0B.Types.SVD.UInt3;
   ...
   subtype PDMCR_MICNBR_Field is A0B.Types.SVD.UInt2;
   ...
   subtype PDMDLY_DLYM1L_Field is A0B.Types.SVD.UInt3;
   subtype PDMDLY_DLYM1R_Field is A0B.Types.SVD.UInt3;
   subtype PDMDLY_DLYM2L_Field is A0B.Types.SVD.UInt3;
   subtype PDMDLY_DLYM2R_Field is A0B.Types.SVD.UInt3;
   subtype PDMDLY_DLYM3L_Field is A0B.Types.SVD.UInt3;
   subtype PDMDLY_DLYM3R_Field is A0B.Types.SVD.UInt3;
   subtype PDMDLY_DLYM4L_Field is A0B.Types.SVD.UInt3;
   subtype PDMDLY_DLYM4R_Field is A0B.Types.SVD.UInt3;
   ...
   type SAI_Peripheral is record
      ...
      --  AData register
      ADR    : aliased A0B.Types.SVD.UInt32;
      --  BConfiguration register 1
      ...
      --  BData register
      BDR    : aliased A0B.Types.SVD.UInt32;
      --  PDM control register
      PDMCR  : aliased PDMCR_Register;
      pragma Volatile_Full_Access (PDMCR);
      --  PDM delay register
      PDMDLY : aliased PDMDLY_Register;
      pragma Volatile_Full_Access (PDMDLY);
   end record
     with Volatile;
