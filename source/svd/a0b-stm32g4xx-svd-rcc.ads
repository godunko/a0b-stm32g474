...
package A0B.STM32G4XX.SVD.RCC is
   pragma Preelaborate;
...
--  stable, OFF if not).
   ...
   type RCC_CR_Register is record
      ...
      HSION          : RCC_CR_HSION_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      HSIKERON       : RCC_CR_HSIKERON_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      HSIRDY         : RCC_CR_HSIRDY_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      ...
      --  This bit cannot be reset if the HSE oscillator is used directly or
      --  indirectly as the system clock.
      HSEON          : RCC_CR_HSEON_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      HSERDY         : RCC_CR_HSERDY_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      HSEBYP         : RCC_CR_HSEBYP_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  Clock security system enable Set by software to enable the clock
      --  security system. When CSSON is set, the clock detector is enabled by
      ...
      --  cleared by reset.
      CSSON          : RCC_CR_CSSON_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      ...
      --  clock.
      PLLON          : RCC_CR_PLLON_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  Read-only. Main PLL clock ready flag Set by hardware to indicate that
      --  the main PLL is locked.
      PLLRDY         : RCC_CR_PLLRDY_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
   ...
   type RCC_CFGR_Register is record
      ...
      --  Reserved Note: This clock output may have some truncated cycles at
      --  startup or during MCO clock source switching.
      MCOSEL         : RCC_CFGR_MCOSEL_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      MCOPRE         : RCC_CFGR_MCOPRE_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      Reserved_31_31 : A0B.Types.SVD.Bit := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   type RCC_PLLCFGR_Register is record
      ...
      PLLM           : RCC_PLLCFGR_PLLM_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  Main PLL multiplication factor for VCO Set and cleared by software to
      ...
      --  these bits correctly not to exceed 170 MHz on this domain.
      PLLP           : RCC_PLLCFGR_PLLP_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      ...
      --  this domain.
      PLLQ           : RCC_PLLCFGR_PLLQ_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      ...
      PLLR           : RCC_PLLCFGR_PLLR_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
   ...
   type RCC_CIER_Register is record
      ...
      LSIRDYIE       : RCC_CIER_LSIRDYIE_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      LSERDYIE       : RCC_CIER_LSERDYIE_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      Reserved_2_2   : A0B.Types.SVD.Bit := 16#0#;
      --  HSI16 ready interrupt enable Set and cleared by software to
      --  enable/disable interrupt caused by the HSI16 oscillator
      --  stabilization.
      HSIRDYIE       : RCC_CIER_HSIRDYIE_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      HSERDYIE       : RCC_CIER_HSERDYIE_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  PLL ready interrupt enable Set and cleared by software to
      --  enable/disable interrupt caused by PLL lock.
      PLLRDYIE       : RCC_CIER_PLLRDYIE_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      ...
      --  system on LSE.
      LSECSSIE       : RCC_CIER_LSECSSIE_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  HSI48 ready interrupt enable Set and cleared by software to
      --  enable/disable interrupt caused by the internal HSI48 oscillator.
   ...
   type RCC_CICR_Register is record
      ...
      CSSC           : RCC_CICR_CSSC_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  Write-only. LSE Clock security system interrupt clear This bit is set
      --  by software to clear the LSECSSF flag.
      LSECSSC        : RCC_CICR_LSECSSC_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
   ...
   type RCC_AHB1ENR_Register is record
      ...
      FLASHEN        : RCC_AHB1ENR_FLASHEN_Field :=
                        A0B.STM32G4XX.SVD.RCC.B_0x1;
      --  unspecified
      Reserved_9_11  : A0B.Types.SVD.UInt3 := 16#0#;
      --  CRC clock enable Set and cleared by software.
      CRCEN          : RCC_AHB1ENR_CRCEN_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      Reserved_13_31 : A0B.Types.SVD.UInt19 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   type RCC_AHB2ENR_Register is record
      ...
      Reserved_20_23 : A0B.Types.SVD.UInt4 := 16#0#;
      --  AES clock enable Set and cleared by software.
      AESEN          : RCC_AHB2ENR_AESEN_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      Reserved_25_25 : A0B.Types.SVD.Bit := 16#0#;
      --  RNG enable Set and cleared by software.
      RNGEN          : RCC_AHB2ENR_RNGEN_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      Reserved_27_31 : A0B.Types.SVD.UInt5 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   type RCC_AHB3ENR_Register is record
      --  Flexible static memory controller clock enable Set and cleared by
      --  software.
      FMCEN         : RCC_AHB3ENR_FMCEN_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      Reserved_1_7  : A0B.Types.SVD.UInt7 := 16#0#;
      --  QUADSPI memory interface clock enable Set and cleared by software.
      QSPIEN        : RCC_AHB3ENR_QSPIEN_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      Reserved_9_31 : A0B.Types.SVD.UInt23 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
...
--  Stop modes
   ...
   type RCC_CCIPR_Register is record
      ...
      --  RNG.
      CLK48SEL   : RCC_CCIPR_CLK48SEL_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      ADC12SEL   : RCC_CCIPR_ADC12SEL_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  ADC3/4/5 clock source selection These bits are set and cleared by
      --  software to select the clock source used by the ADC345 interface.
      ADC345SEL  : RCC_CCIPR_ADC345SEL_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   type RCC_BDCR_Register is record
      --  LSE oscillator enable Set and cleared by software.
      LSEON          : RCC_BDCR_LSEON_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      LSERDY         : RCC_BDCR_LSERDY_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      LSEBYP         : RCC_BDCR_LSEBYP_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  LSE oscillator drive capability Set by software to modulate the LSE
      --  oscillators drive capability. The oscillator is in Xtal mode when it
      --  is not in bypass mode.
      LSEDRV         : RCC_BDCR_LSEDRV_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      LSECSSON       : RCC_BDCR_LSECSSON_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      LSECSSD        : RCC_BDCR_LSECSSD_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      ...
      --  used to reset them.
      RTCSEL         : RCC_BDCR_RTCSEL_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      Reserved_10_14 : A0B.Types.SVD.UInt5 := 16#0#;
      --  RTC clock enable Set and cleared by software.
      RTCEN          : RCC_BDCR_RTCEN_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  RTC domain software reset Set and cleared by software.
      BDRST          : RCC_BDCR_BDRST_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      Reserved_17_23 : A0B.Types.SVD.UInt7 := 16#0#;
      --  Low speed clock output enable Set and cleared by software.
      LSCOEN         : RCC_BDCR_LSCOEN_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  Low speed clock output selection Set and cleared by software.
      LSCOSEL        : RCC_BDCR_LSCOSEL_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      Reserved_26_31 : A0B.Types.SVD.UInt6 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   type RCC_CSR_Register is record
      --  LSI oscillator enable Set and cleared by software.
      LSION          : RCC_CSR_LSION_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      LSIRDY         : RCC_CSR_LSIRDY_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      Reserved_2_22  : A0B.Types.SVD.UInt21 := 16#0#;
      --  Remove reset flag Set by software to clear the reset flags.
      RMVF           : RCC_CSR_RMVF_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      --  unspecified
      Reserved_24_24 : A0B.Types.SVD.Bit := 16#0#;
      ...
      --  to the RMVF bit.
      IWDGRSTF       : RCC_CSR_IWDGRSTF_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      WWDGRSTF       : RCC_CSR_WWDGRSTF_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
      ...
      --  writing to the RMVF bit.
      LPWRRSTF       : RCC_CSR_LPWRRSTF_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   type RCC_CRRCR_Register is record
      ...
      HSI48ON        : RCC_CRRCR_HSI48ON_Field := A0B.STM32G4XX.SVD.RCC.B_0x0;
