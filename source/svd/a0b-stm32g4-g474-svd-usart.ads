...
package A0B.STM32G4.G474.SVD.USART is
   pragma Preelaborate;
   ...
   subtype CR2_ADD0_3_Field is A0B.Types.SVD.UInt4;
   subtype CR2_ADD4_7_Field is A0B.Types.SVD.UInt4;
   ...
   subtype CR3_WUS_Field is A0B.Types.SVD.UInt2;
   subtype CR3_RXFTCFG_Field is A0B.Types.SVD.UInt3;
   subtype CR3_TXFTCFG_Field is A0B.Types.SVD.UInt3;
   ...
   subtype BRR_BRR_Field is A0B.Types.SVD.UInt20;
   ...
   type ISR_Register is record
      ...
      RXFF           : Boolean;
      --  unspecified
      Reserved_25_25 : A0B.Types.SVD.Bit;
      --  Read-only. RXFT
      RXFT           : Boolean;
      --  Read-only. TXFT
      TXFT           : Boolean;
   ...
   subtype RDR_RDR_Field is A0B.Types.SVD.UInt9;
   ...
   subtype TDR_TDR_Field is A0B.Types.SVD.UInt9;
   ...
   subtype PRESC_PRESCALER_Field is A0B.Types.SVD.UInt4;
   ...
   subtype CR3_SCARCNT_Field is A0B.Types.SVD.UInt3;
   ...
   subtype RTOR_RTO_Field is A0B.Types.SVD.UInt24;
   subtype RTOR_BLEN_Field is A0B.Types.SVD.Byte;
   ...
   type ICR_Register_1 is record
      ...
      UDRCF          : Boolean := False;
      --  unspecified
      Reserved_14_16 : A0B.Types.SVD.UInt3 := 16#0#;
      --  Write-only. Character match clear flag
      CMCF           : Boolean := False;
      --  unspecified
      Reserved_18_19 : A0B.Types.SVD.UInt2 := 16#0#;
   ...
   type LPUART1_Peripheral is record
      ...
      pragma Volatile_Full_Access (RQR);
      --  Interrupt & status register
      ...
      pragma Volatile_Full_Access (PRESC);
   end record
     with Volatile;
...
end A0B.STM32G4.G474.SVD.USART;
